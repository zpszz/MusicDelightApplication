...
import com.jpc.lib_base.utils.StatusBarUtil
...
/**
 * 一个基于ViewModel和DataBinding的Activity基类
 * @param VM ViewModel的泛型
 * @param B DataBinding的泛型
 * @property contentViewResId Int 布局文件的资源id
 */
